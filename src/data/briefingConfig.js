...
export const BRIEFING_SECTIONS = [
  ...
  // ── 8. Repérage & Timeline ───────────────────────────────
  {
    ...
    questions: [
      ...
      { key: 'reperage_entree_principale', label: 'Photo — Entrée principale',  type: 'media',      showIf: { question_key: 'reperage_effectue', operator: 'equals', value: 'Oui' } },
      { key: 'reperage_entree_service',    label: 'Photo — Entrée service',     type: 'media',      showIf: { question_key: 'reperage_effectue', operator: 'equals', value: 'Oui' } },
      { key: 'reperage_bar',               label: 'Photo — Bar(s)',              type: 'media',      showIf: { question_key: 'reperage_effectue', operator: 'equals', value: 'Oui' } },
      { key: 'reperage_backoffice',        label: 'Photo — Backoffice',         type: 'media',      showIf: { question_key: 'reperage_effectue', operator: 'equals', value: 'Oui' } },
      { key: 'reperage_cuisine',           label: 'Photo — Cuisine',            type: 'media',      showIf: { question_key: 'reperage_effectue', operator: 'equals', value: 'Oui' } },
      { key: 'reperage_poubelles',         label: 'Photo — Poubelles',          type: 'media',      showIf: { question_key: 'reperage_effectue', operator: 'equals', value: 'Oui' } },
